...
A complete reference for all Markdown syntax supported by **Markdown Editor**, implementing [CommonMark](https://commonmark.org/) plus [GitHub Flavored Markdown (GFM)](https://github.github.com/gfm/) extensions.
